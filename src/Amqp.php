...
use App;
use Closure;
use KamiOrz\Amqp\Request;
use KamiOrz\Amqp\Message;
...
class Amqp
{
    ...
    public function publish($routing, $message, array $properties = [])
    {
        ...
        $publisher = App::make('KamiOrz\Amqp\Publisher');
        $publisher
    ...
    public function consume($queue, Closure $callback, $properties = [])
    {
        ...
        $consumer = App::make('KamiOrz\Amqp\Consumer');
        $consumer
            ->mergeProperties($properties)
            ->setup();
