# kamiorz/lumen-amqp
AMQP wrapper for Lumen to publish and consume messages especially from RabbitMQ
...
```
$ php composer require kamiorz/lumen-amqp
```
...
from **vendor/kami/lumen-amqp/config/amqp.php** to **config/amqp.php**.
